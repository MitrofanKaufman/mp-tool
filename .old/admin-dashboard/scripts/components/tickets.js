...
class TicketsPanel extends HTMLElement {
    constructor() {
        ...
        this.currentUser = 'admin'; // Текущий пользователь
    }
            ...
            <div class="ticket-item ${!ticket.readBy.includes(this.currentUser) ? 'unread' : ''}" data-id="${ticket.id}">
                <div class="ticket-header">
                    <div class="ticket-title">
                        ...
                        <div class="ticket-meta">
                            ...
                            <span class="badge" style="background: ${ticket.category?.color || '#6b7280'}">${ticket.category?.name || 'Без категории'}</span>
                ...
                <div class="ticket-body">
                    ...
                    <div class="ticket-details">
                        ...
                        ${ticket.readBy && ticket.readBy.length > 0 ? `<span>👁️ Прочитали: ${ticket.readBy.join(', ')}</span>` : ''}
                    </div>
